...
export default function GalleryPage() {
    ...
    const handleSave = async (e: React.FormEvent) => {
        ...
        const url = currentItem.id
            ? `/api/admin/home/gallery/${currentItem.id}`
            : '/api/admin/home/gallery'
    ...
    const confirmDelete = async () => {
        ...
        try {
            const res = await fetch(`/api/admin/home/gallery/${itemToDelete}`, { method: 'DELETE' })
            if (res.ok) {
                ...
                <table className="w-full text-center text-sm">
                    <thead className="bg-[#f8f9fa] border-b border-gray-300 text-gray-700 font-bold">
                        <tr>
                            ...
                            <th className="px-4 py-3 border-r border-gray-300 w-28">图片</th>
                        ...
                        {items.map((item, index) => (
                            <tr key={item.id} className="hover:bg-gray-50 transition-colors">
                                ...
                                <td className="px-2 py-2 border-r border-gray-200">
                                    {item.image && (
                                        <img src={item.image} alt="Image" className="h-10 w-16 object-contain mx-auto" />
                                    )}
                                </td>
                    ...
                    <div className="bg-[#f0f2f5] w-full max-w-lg shadow-xl overflow-hidden rounded-sm animate-fade-in-up">
                        ...
                        <form onSubmit={handleSave} className="p-8 space-y-5">
                            ...
                            <div className="flex items-start">
                                <label className="w-24 text-right pr-4 text-gray-600 font-bold text-sm pt-2">图片:</label>
                                <div className="flex-1">
                                    <div
                                    ...
                                    >
                                        {currentItem.image ? (
                                            <img src={currentItem.image} alt="Image" className="w-full h-full object-contain p-2" />
                                        ) : (
                                            <>
