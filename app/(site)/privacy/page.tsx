...
export default function PrivacyPage() {
    ...
    useEffect(() => {
        ...
        fetch(`/api/legal-documents?type=privacy&lang=${lang}`)
            .then(res => {
        ...
        <div className="min-h-screen bg-[#0a0a0a] text-white">
            ...
            <div className="relative pt-32 pb-16 overflow-hidden">
                ...
                <div className="relative max-w-4xl mx-auto px-6 text-center">
                    ...
                    <p className="text-gray-400 text-lg">
                        {isZh ? '了解我们如何收集、使用和保护您的个人信息' : 'Learn how we collect, use, and protect your personal information'}
                    </p>
                </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto px-6 pb-20">
                ...
                <nav className="flex items-center gap-2 text-sm text-gray-500 mb-8">
                    ...
                    <span>/</span>
                    <span className="text-gray-300">{isZh ? '隐私政策' : 'Privacy Policy'}</span>
                </nav>
                ...
                <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-8 md:p-12 backdrop-blur-sm">
                    {loading ? (
                        ...
                        <div className="text-center py-20 text-gray-500">
                            ...
                            <p className="text-lg">{isZh ? '暂未上传隐私政策' : 'Privacy Policy not available yet'}</p>
                        </div>
                    ) : (
